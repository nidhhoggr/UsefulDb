<?php
  ...
  class DB
  {
    ...
    function find($table, $fields="*", $order = null) {
    ...
    function findBy($table, $fields = "*", $conditions = null, $order = null, $debug=false) {
    ...
    function findOneBy($table, $fields, $conditions=null, $order = null, $debug=false) {
